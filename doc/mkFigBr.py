...
p.plot(x, y, label='intermediarios')
...
ax = p.plot(xx, yy, label='periféricos')
...
p.title("Posicionamento dos vértices no Versinus", fontsize=16)

p.subplots_adjust(left=0.06, bottom=0.06, right=0.97, top=0.93)

p.savefig("./nodePositioningBr.png")
# p.show()
